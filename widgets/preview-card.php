...
class preview_Card_widget extends Widget_Base
{
    ...
    {
        return esc_html__('Preview Card Widget', 'preview-card');
    }
    ...
    public function _register_controls()
    {
        ...
        $this->add_control(
            'image',
            [
                'label' => __('Choose Image', 'preview-card'),
        ...
        $this->add_control(
            'show_image_link',
            [
                'label' => __('Show Image Link', 'preview-card'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'preview-card'),
                'label_off' => __('Hide', 'preview-card'),
                'return_value' => 'yes',
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'image_link',
            [
                'label' => __('Image Link', 'preview-card'),
                'type' => \Elementor\Controls_Manager::URL,
                'placeholder' => __('https://your-link.com', 'preview-card'),
                'show_external' => true,
                'default' => [
                    'url' => '',
                    'is_external' => true,
        ...
        $this->add_control(
            'card_title',
            [
                'label' => __('Card Title', 'preview-card'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Default title', 'preview-card'),
                'label_block' => true,
                'placeholder' => __('Type your title here', 'preview-card'),
            ]
        );
        ...
        $this->add_control(
            'show_divider',
            [
                'label' => __('Show Divider', 'preview-card'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'preview-card'),
                'label_off' => __('Hide', 'preview-card'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'item_description',
            [
                'label' => __('Description', 'preview-card'),
                'type' => \Elementor\Controls_Manager::WYSIWYG,
                'default' => __('Default description', 'preview-card'),
                'placeholder' => __('Type your description here', 'preview-card'),
            ]
        );
        ...
        $this->add_control(
            'show_top_badge',
            [
                'label' => __('Show Top Badge', 'preview-card'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'preview-card'),
                'label_off' => __('Hide', 'preview-card'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'top_badge_text',
            [
                'label' => __('Top Badge Text', 'preview-card'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('On Sale!', 'preview-card'),
                'placeholder' => __('Type your title here', 'preview-card'),
                'condition' => [
                    'show_top_badge' => 'yes',
                ],
        ...
        $this->add_control(
            'show_middle_badge',
            [
                'label' => __('Show Middle Badge', 'preview-card'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'preview-card'),
                'label_off' => __('Hide', 'preview-card'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'middle_badge_text',
            [
                'label' => __('Middle Badge Text', 'preview-card'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('$19.99', 'preview-card'),
                'placeholder' => __('Type your title here', 'preview-card'),
                'condition' => [
        ...
        $this->add_control(
            'show_bottom_badge',
            [
                'label' => __('Show Bottom Badge', 'preview-card'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'preview-card'),
                'label_off' => __('Hide', 'preview-card'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'bottom_badge_text',
            [
                'label' => __('Bottom Badge Text', 'preview-card'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('$19.99', 'preview-card'),
                'placeholder' => __('Type your title here', 'preview-card'),
                'condition' => [
        ...
        $this->add_control(
            'button_text',
            [
                'label' => __('Text', 'preview-card'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Buy Now', 'preview-card'),
                'placeholder' => __('Type your text here', 'preview-card'),
            ]
        );
        ...
        $this->add_control(
            'image_width',
            [
                'label' => __('Image Width', 'preview-card'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'description' => __('Default width 100%', 'preview-card'),
                'range' => [
                    'px' => [
                        'min' => 0,
                        'max' => 1000,
        ...
        $this->add_control(
            'image_height',
            [
                'label' => __('Image Height', 'preview-card'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'description' => __('Default Height 250px', 'preview-card'),
                'range' => [
                    'px' => [
                        'min' => 0,
                        'max' => 1000,
        ...
        $this->add_responsive_control(
            'image_border_radius',
            [
                'label' => __('Border Radius', 'preview-card'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'default' => [
                    'top' => 0,
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'box_shadow',
                'label' => __('Box Shadow', 'preview-card'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Bottom Spacing', 'preview-card'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
        ...
        $this->add_control(
            'content_title_color',
            [
                'label' => __('Title Color', 'preview-card'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'preview-card'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Description Color', 'preview-card'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Background Color', 'preview-card'),
                'type' => \Elementor\Controls_Manager::COLOR,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Top Badge', 'preview-card'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Text Color', 'preview-card'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#fff',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Middle Badge', 'preview-card'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Bottom Badge', 'preview-card'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Buy Button', 'preview-card'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new preview_Card_widget() );
